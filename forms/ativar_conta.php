                ...
                <div class="card-body">
                  ...
                  <form class="needs-validation" novalidate>
                    ...
                    <div class="md-form form-sm mb-5">
                      ...
                      <label data-error="inválido" data-success="válido" for="modalLRInput10" class="white-text">Seu E-mail</label>
                    </div>

                    <div class="md-form form-sm mb-4">
                      <i class="fas fa-lock prefix"></i>
                      <input type="password" id="modalLRInput11" class="form-control form-control-sm validate" required>
                      <label  data-error="inválido" data-success="válido" for="modalLRInput11" class="white-text">Sua Senha</label>
                    </div>
